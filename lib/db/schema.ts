...
export const processedGames = pgTable(
	'processed_games',
	{
		...
		controllerSupport: varchar('controller_support', { length: 50 }),
...
export const priceOverviews = pgTable(
	'price_overviews',
	{
		...
		initialFormatted: varchar('initial_formatted', { length: 50 }).notNull(),
		finalFormatted: varchar('final_formatted', { length: 50 }).notNull(),
	},
	(table) => ({
...
export const packageGroups = pgTable(
	'package_groups',
	{
		...
		isRecurringSubscription: varchar('is_recurring_subscription', { length: 50 }).notNull(),
	},
	(table) => ({
...
export const subs = pgTable(
	'subs',
	{
		...
		percentSavingsText: varchar('percent_savings_text', { length: 50 }),
		...
		canGetFreeLicense: varchar('can_get_free_license', { length: 50 }).notNull(),
...
export const ratings = pgTable(
	'ratings',
	{
		...
		requiredAge: varchar('required_age', { length: 50 }).notNull(),
		banned: varchar('banned', { length: 50 }).notNull(),
		useAgeGate: varchar('use_age_gate', { length: 50 }).notNull(),
