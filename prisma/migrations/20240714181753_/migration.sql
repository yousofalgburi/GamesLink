/*
  ...
  - Added the required column `categoriesList` to the `ProcessedGame` table without a default value. This is not possible if the table is not empty.
  - Added the required column `genresList` to the `ProcessedGame` table without a default value. This is not possible if the table is not empty.
...
CREATE TABLE "new_ProcessedGame" (
    ...
    "categoriesList" TEXT NOT NULL,
    "genresList" TEXT NOT NULL,
