					...
					<div className='mx-auto max-w-[85rem] px-4 sm:px-6 lg:px-8'>
						<div className='flex translate-y-40 flex-col items-center opacity-0 transition-all'>
							<div className='relative mb-1  rounded-full px-3 py-1 text-sm leading-6 ring-1 ring-gray-900/10 hover:ring-gray-900/20'>
								<a className='flex gap-2' target='_blank' href='https://github.com/yousofalgburi/GamesLink'>
									We are open source!
									<Github />
								</a>
							</div>
								...
								<div className='space-y-6 opacity-0 transition-all sm:space-y-8'>
									<div className='space-y-2 md:space-y-4'>
										...
										<p className='text-gray-500'>
											Many gamers have experiencd the problem of not knowing what to play. Our platform aims to solve
											that problem.
										</p>
									</div>
							...
							<div className='grid gap-6 sm:grid-cols-2 md:gap-12'>
								<div>
									...
									<p className='mt-2 text-gray-600 dark:text-gray-400'>
										GamesLink offers a generous free tier experinece. We also offer paid features like the Link Room but
										we give you starter credits to try it out.
									</p>
								</div>
								...
								<div>
									...
									<p className='mt-2 text-gray-600 dark:text-gray-400'>
										The credits are used in the Link Room where a credit per person is used and link results are saved
								...
								<div>
									...
									<p className='mt-2 text-gray-600 dark:text-gray-400'>
										While we have a big library of games, we do not have every game in the world. We are currently
										working on developing a system that allows users to submit games to be reviewed and added to the
										site.
									</p>
								</div>
								...
								<div>
									...
									<p className='mt-2 text-gray-600 dark:text-gray-400'>
										GamesLink is currently single region with English as the only language. We are currently working on
										making it accessible in other languages and give you the ability to get region specific
										recommendations.
									</p>
								</div>
							</div>
