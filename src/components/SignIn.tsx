		...
		<>
			<Dialog>
				<DialogTrigger asChild>
					<Button variant={variant ?? 'default'} className='className="text-sm hover:underline" flex gap-2 font-medium underline-offset-4'>
						Sign In
					</Button>
				</DialogTrigger>
				<DialogContent className='sm:max-w-[425px]'>
					...
					<div className='flex flex-col space-y-2 text-center'>
						...
						<p className='mx-auto max-w-xs text-sm'>
							By continuing, you are setting up a GamesLink account and agree to our User Agreement and Privacy Policy.
						</p>
					</div>
